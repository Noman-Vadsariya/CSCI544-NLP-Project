#!/usr/bin/env python3
"""
print_fol_from_validation.py

Reads a validation JSON file, extracts each question, parses it to AMR,
converts AMR to FOL, and prints:

- question
- generated FOL logic representation

Example:
    python print_fol_from_validation.py validation_subset.json --limit 3
"""
