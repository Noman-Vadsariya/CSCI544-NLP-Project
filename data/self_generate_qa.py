...
from src.hypernetwork.ctx_to_lora.data.self_gen_template import (
    PRE_CTX,
    PROMPT_TEMPLATE,
    QA_PROMPT_TEMPLATE,
    SELF_GEN_SYSTEM_MSG,
...
from src.hypernetwork.ctx_to_lora.utils import clear_gpu
...
def self_generate(
    ...
    if parquet_file:
        ...
        ds = load_and_process_dataset(**kwargs, num_proc=8, remove_cols=False, add_negative_prompt=False)
