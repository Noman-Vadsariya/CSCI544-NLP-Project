  ...
  <div class="shell">
    <header class="topbar">
      <div class="title">
        <div class="dot"></div>
        <div>
          <div class="h1">Text Formatter Bot</div>
          <div class="h2">Localhost • token-gated • XSS-safe</div>
        </div>
      </div>
    </header>
    ...
    <main class="chat" id="chat">
      <div class="empty" id="emptyState">
        <div class="emptyCard">
          <div class="emptyTitle">Paste text in your terminal</div>
          <div class="emptySub">
            Every submission appears here as a chat: raw user text + formatted markdown response.
          </div>
          <div class="emptyHint">
            Terminal commands: <code>:clear</code> <code>:quit</code>
          </div>
        </div>
      </div>
    ...
    <footer class="composer">
      <textarea id="input" placeholder="Optional: type here and click Send (still token-gated)."></textarea>
